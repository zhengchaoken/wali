	...
	<div id="primary" class="content-area <?php echo $firmasite_settings["layout_primary_class"]; ?>">
		<div class="padder">
			...
			<form action="" method="post" id="forums-search-form" class="dir-form">
				...
				<h3 class="page-header"><?php _e( 'Forums Directory', 'firmasite' ); ?><?php if ( is_user_logged_in() ) : ?> &nbsp;<a class="button btn btn-default show-hide-new" href="#new-topic" id="new-topic-button"><?php _e( 'New Topic', 'firmasite' ); ?></a><?php endif; ?></h3>
					...
					<?php if ( bp_is_active( 'groups' ) && bp_has_groups( 'user_id=' . bp_loggedin_user_id() . '&type=alphabetical&max=100&per_page=100' ) ) : ?>
						...
						<form action="" method="post" id="forum-topic-form" class="standard-form">
							...
							<div class="submit">
								...
								<input type="button" class="btn btn-default"  name="submit_topic_cancel" id="submit_topic_cancel" value="<?php _e( 'Cancel', 'firmasite' ); ?>" />
							</div>
