...
get_header( 'buddypress' ); ?>
	...
	<div id="primary" class="content-area <?php echo $firmasite_settings["layout_primary_class"]; ?>">
		...
		<?php do_action( 'template_notices' ); ?>
			...
			<h3 class="page-header"><?php _e( 'Create a Site', 'firmasite' ); ?> &nbsp;<a class="button btn btn-default" href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_blogs_root_slug() ); ?>"><?php _e( 'Site Directory', 'firmasite' ); ?></a></h3>
