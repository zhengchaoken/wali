<h4 ><?php _e( 'Change Avatar', 'firmasite' ); ?></h4>
	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<?php if ( bp_get_user_has_avatar() ) : ?>
				...
				<p><a class="button btn btn-default edit" href="<?php bp_avatar_delete_link(); ?>" title="<?php _e( 'Delete Avatar', 'firmasite' ); ?>"><?php _e( 'Delete My Avatar', 'firmasite' ); ?></a></p>
			<?php endif; ?>
