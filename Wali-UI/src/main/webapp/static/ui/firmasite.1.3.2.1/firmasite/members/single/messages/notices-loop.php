	...
	<table id="message-threads" class="table messages-notices">
		<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
			<tr id="notice-<?php bp_message_notice_id(); ?>" class="<?php bp_message_css_class(); ?>">
				...
				<td width="10%">
					<a class="button btn btn-default" href="<?php bp_message_activate_deactivate_link(); ?>" class="confirm"><?php bp_message_activate_deactivate_text(); ?></a>
					<a class="button btn btn-default" href="<?php bp_message_notice_delete_link(); ?>" class="confirm" title="<?php _e( "Delete Message", 'firmasite' ); ?>">x</a>
				</td>
			</tr>
		<?php endwhile; ?>
