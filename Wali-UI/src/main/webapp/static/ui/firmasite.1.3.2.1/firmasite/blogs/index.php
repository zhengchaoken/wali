...
get_header( 'buddypress' ); ?>
	...
	<div id="primary" class="content-area <?php echo $firmasite_settings["layout_primary_class"]; ?>">
		...
		<form action="" method="post" id="blogs-directory-form" class="dir-form">
			...
			<h3 class="page-header"><?php _e( 'Site Directory', 'firmasite' ); ?><?php if ( is_user_logged_in() && bp_blog_signup_enabled() ) : ?> &nbsp;<a class="button btn btn-default" href="<?php echo bp_get_root_domain() . '/' . bp_get_blogs_root_slug() . '/create/' ?>"><?php _e( 'Create a Site', 'firmasite' ); ?></a><?php endif; ?></h3>
